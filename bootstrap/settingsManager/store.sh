...
_NDS_EXPORT_SKIP="FLAKE_LOCATION FLAKE_SOURCE GIT_AUTH_METHOD GIT_DEPLOY_KEY_IMPORT_PATH GIT_DEPLOY_KEY_DISPLAY GIT_DEPLOY_KEY_USE_QR CURRENT_ACTION RUNTIME_DIR ACTION ACTION_PREVIEW_SKIP SKIP_MENU CONFIG_CONFIRM_SKIP INSTALL_CONFIRM_SKIP REMOTE_CONFIRM_SKIP GIT_AUTH_SKIP DISK_FORMAT_CONFIRM_SKIP BACKUP_CONFIRM_SKIP REBOOT_SKIP SCAFFOLD_OVERWRITE_SKIP HARDWARE_OVERWRITE_SKIP PREFLIGHT_WARN_SKIP PREFLIGHT_BUILD_SKIP PROMPTS_SKIP AUTO_CONFIRM"
