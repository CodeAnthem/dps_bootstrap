...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# Date:          Created: 2026-06-27 | Modified: 2026-07-09
...
_nixinstall_write_mounts_nix() {
    ...
    if [[ -f "${host_dir}/mounts.nix" ]] && grep -q 'by-label' "${host_dir}/mounts.nix" 2>/dev/null; then
        log "mounts.nix present (by-label) — skip UUID rewrite for ${hostname}"
        return 0
    fi
