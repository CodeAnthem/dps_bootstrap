...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# Date:          Created: 2025-10-12 | Modified: 2025-10-22
...
checkUntrackedFiles() {
    ...
    if [[ -n "$untracked" ]]; then
        printf " %(%Y-%m-%d %H:%M:%S)T %s\n" -1 "Quickstart | Untracked files detected (potential security risk)" >&2
        ...
        case "${answer^^}" in
            Y)
                ...
                ;;
            *)
                printf " %(%Y-%m-%d %H:%M:%S)T %s\n" -1 "Quickstart | Proceeding with untracked files present" >&2
                ;;
        esac
    fi
}
