...
Cycles through shared prompts, settingsManager field asks, install/app confirms
(with fake disk/IP), git collision/hints, and failure display so you can verify
menu wiring after UI/logic peels.
...
Automated selftests: `bash src/tests/run.sh` / `bash dev/selftest.sh` (also CI).
